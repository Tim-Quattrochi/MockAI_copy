                  ...
                  <div className="bg-[#1a1c3d] rounded-lg p-6 border-b border-[#2e2f61]">
                    ...
                    <p className="text-[#f0f0f0]">
                      ...
                      result.pause_durations === 0 ? (
                        ...
                        <span>
                          {result.pause_durations} pauses of 10
                          seconds or more detected. Consider
                          practicing how to gather your thoughts
                          quickly to maintain the flow of conversation
                          and confidence in your responses.
                        </span>
                      )}
                    </p>
                  </div>
          ...
          <Card className="bg-[#0a0b24] border-[#2e2f61] mb-6">
            <CardContent>
              <div className="flex flex-col items-center justify-center py-10">
                ...
                >
                  <Play className="mr-2 h-4 w-4" /> Start New
                  Interview
                </Button>
              </div>
            </CardContent>
